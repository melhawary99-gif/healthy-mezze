...
export const spinachFatayer: Recipe = {
  ...
  description:
    "Traditional Lebanese baked pastries filled with spinach, onions, herbs, lemon juice, and tangy sumac. A healthy mezze that's perfect as an appetizer, snack, or light meal.",
