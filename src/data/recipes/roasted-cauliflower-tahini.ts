...
export const roastedCauliflowerTahini: Recipe = {
  ...
  description:
    "Tender roasted cauliflower florets topped with creamy tahini sauce, toasted pine nuts, fresh parsley, and a squeeze of lemon for a delicious Lebanese mezze.",
