...
export const warakEnab: Recipe = {
  ...
  description:
    "Tender grape leaves stuffed with seasoned rice, fresh herbs, tomatoes, onions, and aromatic spices, gently simmered in a bright lemon broth. A classic Lebanese mezze enjoyed warm or cold.",
