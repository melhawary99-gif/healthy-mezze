...
export const healthyBakedAtayef: Recipe = {
  ...
  description:
    "Soft Middle Eastern pancakes filled with creamy ricotta, Greek yogurt, pistachios, and lightly sweetened with honey. Baked instead of fried for a healthier traditional dessert.",
