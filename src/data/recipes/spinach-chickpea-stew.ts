...
export const spinachChickpeaStew: Recipe = {
  ...
  slug: "spinach-chickpea-stew",

  description:
    "A hearty Mediterranean stew made with chickpeas, spinach, tomatoes, onions, garlic, and warm spices, simmered until rich and flavorful.",
