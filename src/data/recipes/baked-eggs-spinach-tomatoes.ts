...
export const bakedEggsSpinachTomatoes: Recipe = {
  ...
  description:
    "Tender baked eggs nestled in a flavorful mixture of spinach, cherry tomatoes, garlic, and feta cheese. A simple Mediterranean breakfast that's both nutritious and satisfying.",
