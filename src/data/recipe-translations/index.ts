...
import { HealthyRozBelLabanAr } from "./ar/healthy-roz-bel-laban";
...
import { healthyDateWalnutMaamoulAr } from "./ar/healthy-date-walnut-maamoul";
...
import { authenticAyranEn } from "./en/authentic-ayran";
import { authenticCarobJuiceEn } from "./en/authentic-carob-juice";
import { authenticLebaneseMintTeaEn } from "./en/authentic-lebanese-mint-tea";
import { authenticQamarAlDinEn } from "./en/authentic-qamar-al-din";
import { authenticChermoulaSauceEn } from "./en/authentic-chermoula-sauce";
import { authenticSahlabEn } from "./en/authentic-sahlab";
import { authenticEgyptianKarkadeEn } from "./en/authentic-egyptian-karkade";
...
import { mediterraneanAvocadoToastEn } from "./en/mediterranean-avocado-toast";
import { muhammaraEn } from "./en/muhammara";

import { healthyChickenMakanekEn } from "./en/healthy-chicken-makanek";
import { greekSaladAr } from "./ar/greek-salad";
import { HealthyChickenMakanekAr } from "./ar/healthy-chicken-makanek";
...
import { authenticAyranAr } from "./ar/authentic-ayran";
import { authenticCarobJuiceAr } from "./ar/authentic-carob-juice";
import { authenticLebaneseMintTeaAr } from "./ar/authentic-lebanese-mint-tea";
import { authenticQamarAlDinAr } from "./ar/authentic-qamar-al-din";
import { authenticChermoulaSauceAr } from "./ar/authentic-chermoula-sauce";
import { authenticSahlabAr } from "./ar/authentic-sahlab";
import { authenticEgyptianKarkadeAr } from "./ar/authentic-egyptian-karkade";
...
import { MediterraneanBreakfastWrapAr } from "./ar/mediterranean-breakfast-wrap";
...
const enTranslations: Record<string, RecipeTranslation> = {
  ...
  "healthy-baked-atayef": healthyBakedAtayefEn,
  ...
  "authentic-ayran": authenticAyranEn,
  "authentic-carob-juice": authenticCarobJuiceEn,
  "authentic-lebanese-mint-tea": authenticLebaneseMintTeaEn,
  "authentic-qamar-al-din": authenticQamarAlDinEn,
  "authentic-chermoula-sauce": authenticChermoulaSauceEn,
  "authentic-sahlab": authenticSahlabEn,
  "authentic-egyptian-karkade": authenticEgyptianKarkadeEn,
...
import { redLentilSoupEn } from "./en/red-lentil-soup";
...
const arTranslations: Record<string, RecipeTranslation> = {
  ...
  "healthy-roz-bel-laban": HealthyRozBelLabanAr,
  ...
  "healthy-baked-atayef": HealthyBakedAtayefAr,
  ...
  "authentic-ayran": authenticAyranAr,
  "authentic-carob-juice": authenticCarobJuiceAr,
  "authentic-lebanese-mint-tea": authenticLebaneseMintTeaAr,
  "authentic-qamar-al-din": authenticQamarAlDinAr,
  "authentic-chermoula-sauce": authenticChermoulaSauceAr,
  "authentic-sahlab": authenticSahlabAr,
  "authentic-egyptian-karkade": authenticEgyptianKarkadeAr,
  ...
  "mediterranean-breakfast-wrap": MediterraneanBreakfastWrapAr,
