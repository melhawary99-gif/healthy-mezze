    ...
    <section className="rounded-[2rem] border border-green-100 bg-white p-6 shadow-sm sm:p-8">
      <div className="grid gap-8 lg:grid-cols-[1.25fr_0.75fr] lg:items-end">
        <div>
          ...
          <p className="mt-3 text-sm leading-6 text-gray-600">{t("description")}</p>
        ...
        <div className="rounded-[1.75rem] border border-green-100 bg-emerald-50 p-6">
          <label htmlFor="sort" className="mb-2 block text-sm font-medium text-gray-700">
            {t("sort")}
          </label>
          ...
          >
            ...
            <option value="Prep Time">{t("sortOptions.prepTime")}</option>
          </select>

          <div className="mt-6">
            <p className="mb-3 text-sm font-medium text-gray-700">{t("categories")}</p>
